...
urlpatterns = [
    ...
    path('users/delete_my_account/', views.delete_my_account, name='delete_my_account'),
    ...
    path('gamification/claim_daily/', views.gamification_claim_daily, name='gamification_claim_daily'),
    path('gamification/claim_daily', views.gamification_claim_daily, name='gamification_claim_daily_no_slash'),
    path('gamification/claim/', views.gamification_claim_daily, name='gamification_claim_daily_alias'),
    ...
    path('qaf/cognition/evaluate/', views.qaf_cognition_evaluate, name='qaf_cognition_evaluate'),
    ...
    path('qaf/shape_presence/', views.qaf_shape_presence, name='qaf_shape_presence'),
    path('qaf/posture_proportion/', views.qaf_posture_proportion, name='qaf_posture_proportion'),
]
